...
3. **The field left the whole category on the table.** The hackathon leaderboard carried **110 submissions and zero accessibility or disability entries** on 2026-09-23 — up from 101 on 2026-09-22, with the category still empty (measured, both scans and their method in [`hackathon-strategy.md`](research/hackathon-strategy.md) §4/§4.1; only the top 50 of 110 are readable). AssemblyAI's own hackathon retrospectives repeatedly single out accessibility framing for praise.
